...
function App() {
  ...
  console.log("🚀 ~ file: App.js ~ line 6 ~ App ~ data", data);
  ...
  return (
    <div className="App">
      ...
      <footer>
        Demo built to showcase HarperDB and React. Visit{" "}
        <a href="https://lo-victoria.com">lo-victoria.com</a> to read tutorial.
      </footer>
    </div>
  );
}
